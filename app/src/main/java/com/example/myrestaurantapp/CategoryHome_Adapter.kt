...
class CategoryHome_Adapter : RecyclerView.Adapter<CategoryHome_Adapter.Recycl_holder> {

    var layoutid: Int = 0
    var foodList: ArrayList<FoodDomain>
    var context: Context

    constructor(layoutid: Int, array: ArrayList<FoodDomain>, context: Context) {
    ...
    inner class Recycl_holder : RecyclerView.ViewHolder {
        ...
        constructor(itemView: View) : super(itemView) {
            ...
            itemView.setOnClickListener {
                val meals = foodList.get(adapterPosition) // return Meals
