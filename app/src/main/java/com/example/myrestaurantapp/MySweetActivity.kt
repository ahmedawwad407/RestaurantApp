...
class MySweetActivity : AppCompat() {
    ...
    lateinit var sweet1: FoodDomain
    lateinit var sweet2: FoodDomain
    lateinit var sweet3: FoodDomain

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_my_sweet)
    ...
    fun recyclerViewCategory() {
        ...
        sweet1 = FoodDomain()
        sweet1.photo = R.drawable.sweet
        sweet1.title = "Chocolate Biscuits"
        sweet1.descreption = "Biscuits and Chocolate"
        sweet1.price = 50.0

        sweet2 = FoodDomain()
        sweet2.photo = R.drawable.sweet
        sweet2.title = "Chocolate Biscuits"
        sweet2.descreption = "Biscuits and Chocolate"
        sweet2.price = 50.0

        sweet3 = FoodDomain()
        sweet3.photo = R.drawable.sweet
        sweet3.title = "Chocolate Biscuits"
        sweet3.descreption = "Biscuits and Chocolate"
        sweet3.price = 50.0
